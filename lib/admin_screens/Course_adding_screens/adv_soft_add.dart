...
class AdvancedSoftSkillAddingScreen extends StatefulWidget {
  const AdvancedSoftSkillAddingScreen({Key? key}) : super(key: key);

  @override
  State<AdvancedSoftSkillAddingScreen> createState() => _AdvancedSoftSkillAddingScreenState();
}

class _AdvancedSoftSkillAddingScreenState extends State<AdvancedSoftSkillAddingScreen> {
