...
import 'package:gurukul_team_hacktivators/admin_screens/Course_adding_screens/begin_tech_add.dart';

var docid ="";

class BeginnerTechSkillSeeingScreen extends StatefulWidget {
  @override
  _BeginnerTechSkillSeeingScreenState createState() => _BeginnerTechSkillSeeingScreenState();
}

class _BeginnerTechSkillSeeingScreenState extends State<BeginnerTechSkillSeeingScreen> {
  List<String> _data = [];
  ...
  void _deleteDocument(String fieldName) async {
    ...
    await firestore.collection("beginnertechskills")
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Beginner Tech Skill Courses'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          TextButton(
              onPressed: (){
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context){
                        return BeginnerTechSkillAddingScreen();
                      }
                  ),
                );
              },
