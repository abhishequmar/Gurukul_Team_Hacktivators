...
class AdvanceSoftSkillSeeingScreen extends StatefulWidget {
  @override
  _AdvanceSoftSkillSeeingScreenState createState() => _AdvanceSoftSkillSeeingScreenState();
}

class _AdvanceSoftSkillSeeingScreenState extends State<AdvanceSoftSkillSeeingScreen> {
  List<String> _data = [];
  ...
  void initState() {
    ...
    // Fetch a collection
    firestore.collection("advancedsoftskills").get().then((querySnapshot) {
  ...
  void _deleteDocument(String fieldName) async {
    ...
    await firestore.collection("advancedsoftskills")
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Advance Soft Skill Courses'),
      ),
      body: Column(
        children: [
          SizedBox(
          ...
          TextButton(
              onPressed: (){
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context){
                        return AdvancedSoftSkillAddingScreen();
                      }
                  ),
                );
              },
